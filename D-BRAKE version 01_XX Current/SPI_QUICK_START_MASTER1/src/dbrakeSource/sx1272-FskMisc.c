...
{
    SX1272ReadBuffer2( REG_FRFMSB, &SX1272->RegFrfMsb, 3 );
...
{
    SX1272ReadBuffer2( REG_BITRATEMSB, &SX1272->RegBitrateMsb, 2 );
...
{
    SX1272ReadBuffer2( REG_FDEVMSB, &SX1272->RegFdevMsb, 2 );
